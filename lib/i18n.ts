  ...
  en: {
    ...
    why: {
      ...
      items: [
        ...
        { heading: 'Genuinely small', desc: 'Not "boutique" as a marketing word. Limited to 8–12 people. You won\'t disappear.' },
      ...
      stats: [
        { num: '8–12', label: 'People per retreat' },
        { num: '6', label: 'Days of immersion' },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'How big is the group?', a: "Strictly 8–12 people. This isn't a number we adjust for revenue. Small groups mean real teaching, real relationships, and an experience that actually changes something." },
